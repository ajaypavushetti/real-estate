    ...
    <header className="bg-blue-100 shadow-md">
      ...
      <Link to='/'>
        <h1 className="font-bold text-sm sm:text-xl flex flex-wrap">
          ...
          <span className="text-blue-600">Scape</span>
        </h1>
      </Link>

        <form className="bg-white p-3 rounded-lg flex shadow-sm items-center">
          <input
            type="text"
            placeholder="Search..."
            className="bg-transparent text-gray-600 placeholder-gray-400 px-2 focus:outline-none w-24 sm:w-64"
          />
